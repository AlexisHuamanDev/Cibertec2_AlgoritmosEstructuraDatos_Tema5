...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnListar(ActionEvent arg0) {
		...
		for(int i=0;i<an.tamanio();i++) {
			imprimir("["+i+"] : "+ an.obtener(i));
		}
		imprimir("");
		
	}
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		imprimir("Tamaño del arreglo: "+an.tamanio());
		...
		imprimir("Posicion de primera nota aprobatoria: "+an.posPrimeraNotaAprobatoria());
		imprimir("Posicion de penultima nota desaprobatoria: "+an.posPenultimaNotaDesaprobatoria());
