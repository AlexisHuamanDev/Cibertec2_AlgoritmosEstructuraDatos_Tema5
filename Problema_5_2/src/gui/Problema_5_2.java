...
public class Problema_5_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Tamaño del arreglo: "+as.tamanio());
		imprimir("Sueldo Promedio: "+as.sueldoPromedio());
		imprimir("Sueldo Mayor: "+as.sueldoMayor());
		imprimir("Sueldo Menor: "+as.sueldoMenor());
		imprimir("Cantidad de empleados con sueldos mayor al promedio: "+as.cantMayoresSueldoPromedio());
		imprimir("Cantidad de empleados con sueldos menor al promedio: "+as.cantMenoresSueldoPromedio());
	
		imprimir("Segundo sueldo mayor a 850.0: "+as.posSegundoSueldoMayorAlMinimo());
		imprimir("Ultimo sueldo menor a 850.0: "+as.posUltimoSueldoMenorAlMinimo());
